...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='face2cartoon', help='dataset name')
    ...
    args.result_dir = './train_model/{}-size{}-ch{}-{}-lr{}-adv{}-cyc{}-id{}-identity{}-cam{}'.format(
