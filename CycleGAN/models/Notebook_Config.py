import time
import itertools
from Data_load import ImgFolder
from torchvision import transforms
from torch.utils.data import DataLoader
from .CycleGanConfig import *
from utils import *
from glob import glob
from .Img_Features import ImgFeatures


class Notebook_GanConfig(object):
    def __init__(self, light, result_dir, dataset, iteration, decay_flag, batch_size, print_freq, save_freq, lr, ch,
        ...
        self.faceid_weight = faceid_weight
    ...
    def build_model(self):
        ...
        self.trainA = ImgFolder(os.path.join('dataset', self.dataset, 'trainA'), train_transform)
        self.trainB = ImgFolder(os.path.join('dataset', self.dataset, 'trainB'), train_transform)
        self.testA = ImgFolder(os.path.join('dataset', self.dataset, 'testA'), test_transform)
        self.testB = ImgFolder(os.path.join('dataset', self.dataset, 'testB'), test_transform)
        ...
        self.facenet = ImgFeatures('models/model_mobilefacenet.pth', self.device)
